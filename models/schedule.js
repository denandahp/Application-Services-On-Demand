...
class scheduleModel{
  ...
  async update (data) {
      ...
      let res = await pool.query('UPDATE ' + dbTable + 'SET (username, schedule_name, schedule_start, schedule_end, schedule_date) VALUES ($1, $2, $3, $4, $5) WHERE schedule_id = $1 RETURNING username, schedule_lastdate;', sets);
      debug('update %o', res);
