...
const driverNotifjride = require('./routes/driverNotifjride.js');
...
const customerNotifjride = require('./routes/customerNotifjride.js');
...
app.use('/api/customer/jfood', customerFilterfood);
app.use('/api/customer/jfood', customerMenujfood);
app.use('/api/customer/jfood', customerNotiffood);
app.use('/api/customer/jride', customerNotifjride);
